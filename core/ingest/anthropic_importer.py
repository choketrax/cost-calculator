                ...
                for item in items:
                    ...
                    try:
                        ...
                        records.append(UsageRecord(
                            ...
                            service_provider_name="anthropic",
                            resource_name=item.get("model", "unknown"),
                            ai_model=item.get("model", "unknown"),
                            ai_use_case=application,
                            ai_workflow=workload,
                            consumed_quantity=item.get("request_count", 1),
                ...
                for row in reader:
                    try:
                        ...
                        records.append(UsageRecord(
                            ...
                            ai_cached_tokens=int(row.get("cache_read_input_tokens", 0) or row.get("cached_tokens", 0)),
                            ai_latency_ms=None,
                            ai_status="success",
                            ai_retry_count=0,
                            effective_cost=Decimal("0"),
